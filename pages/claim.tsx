...
export default function Claim() {
		...
		(window as any).ethereum.request({
			...
			params: {
				...
				options: {
					...
					image: "https://app.reax.one/veREAX.svg", // A string url of the token logo
				},
			},
		});
	};
	...
	return (
		<>
			<Head>
				<title>Claim Rewards | REAX</title>
			...
			<Box textAlign={"left"} pt="100px" >
				...
				>
					...
					<Text mb={5} mt={2} color="whiteAlpha.700">
						Provide liquidity by issuing synthetic assets to earn veREAX.
					</Text>
				</motion.div>
