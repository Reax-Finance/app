...
export default function Connect2() {
  ...
  return (
    <>
                  ...
                  <Box>
                    ...
                    <Flex direction={"column"}>
                      <Text mt={2} fontWeight={"500"}>
                        Uh oh! It looks like your wallet isn't on our allowlist.
                      ...
                      <Flex direction={"column"}>
                        ...
                        <Text>
                          → Apply for our public allowlist and we'll notify you
                          when you're in
                        </Text>
                      </Flex>
                    </Flex>
      ...
      <Flex direction="column" gap={10} px={10} py={10} bg={"black"}>
            ...
            <AccordionPanel pb={4}>
              <Flex direction={"column"}>
                ...
                <Flex direction={"column"} ml={6} w={"100%"}>
                  ...
                  <Text>
                    3. Dive in: Once connected, you{"'"}ll be ready to explore
                    all the exciting functionalities on our platform.
                  </Text>
                </Flex>
              </Flex>
            </AccordionPanel>
