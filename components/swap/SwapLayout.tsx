...
export default function SwapLayout({
  ...
  const inputValue = Big(Number(inputAmount) || 0)
    ...
    .div(10 ** 8)
    .toNumber();
  const outputValue = Big(Number(outputAmount) || 0)
    .mul(tokens[outputAssetIndex].price)
    .div(10 ** 8)
    .toNumber();
      ...
      <Box className={`${VARIANT}-${colorMode}-containerBody`} maxW={"540px"}>
        ...
        >
          <Flex align="center" justify={"space-between"}>
            ...
            <SelectBody onOpen={onInputOpen} asset={tokens[inputAssetIndex]} />
          </Flex>
        ...
        <Flex px={{ base: "4", md: "5" }} my={-4} align="center">
          ...
          <Button
            _hover={{
              bg: colorMode == "dark" ? "whiteAlpha.50" : "blackAlpha.100",
            }}
            rounded={"0"}
        ...
        <Box
          ...
          pt={10}
          pb={14}
          bg={colorMode == "dark" ? "darkBg.600" : "lightBg.600"}
        >
          <Flex align="center" justify={"space-between"}>
            <InputGroup width={{ base: "60%", md: "70%" }}>
              <NumberInput
