      ...
      >
        ...
        >
          <Box className={`${VARIANT}-${colorMode}-containerBody`}>
                    ...
                    tokens[tokenIndex] && (
                      <Box key={tokenIndex}>
                        ...
                        <Flex
                          ...
                          onClick={() => selectToken(tokenIndex)}
                        >
                          <Box borderColor={"gray.700"}>
                            <Flex align={"center"} gap={"2"} ml={-1}>
                              <Image
                                src={
                                  "/icons/" + tokens[tokenIndex].symbol + ".svg"
                                }
                                height={"40px"}
                                alt={""}
                              />
                              ...
                              <Box>
                                <Flex gap={1} align={"center"}>
                                  <Text>{tokens[tokenIndex].symbol}</Text>
                            ...
                            >
                              ...
                              <Text fontSize={"md"}>
                                {tokenFormatter.format(
                                  Big(tokens[tokenIndex].balance ?? 0)
                                    .div(
                                      10 ** (tokens[tokenIndex].decimals ?? 18)
                                    )
                                    .toNumber()
                                )}
                              </Text>
            ...
            <Flex
              className={`${VARIANT}-${colorMode}-containerFooter`}
              roundedBottom={16}
              py={1}
              justify="space-between"
              px={4}
