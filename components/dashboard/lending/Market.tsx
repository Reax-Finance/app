            ...
            <Box>
					...
					<Flex mt={7} mb={4} gap={10}>
						<Flex gap={2}>
							...
							<Heading size={"sm"}>{dollarFormatter.format(protocol.totalDepositBalanceUSD)}</Heading>
						</Flex>
						...
						<Flex gap={2}>
							...
							<Heading size={"sm"}>{dollarFormatter.format(protocol.totalBorrowBalanceUSD)}</Heading>
						</Flex>
					</Flex>
				</Box>
        </Box>
