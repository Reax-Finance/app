      ...
      <Tr>
          ...
          <Box>
            ...
            >
              <Flex align={"center"} gap={1} mt={1}>
                <Text fontSize={"sm"}>
                  {history.vault.slice(0, 6)}...{history.vault.slice(-4)}
                </Text>
        ...
        <Td>
          <Flex align={"center"} gap={0.5}>
            <Image
              src={`/icons/${history.tokenSymbol}.svg`}
              boxSize={"20px"}
              mr={2}
              alt={history.tokenSymbol}
            />
            {history.tokenSymbol}
          </Flex>
        </Td>
        ...
        <Td isNumeric>
          <Flex
            ...
            onClick={() =>
              window.open(
                defaultChain.blockExplorers.default.url + "/tx/" + history.hash
              )
            }
          >
            <Text fontSize={"sm"}>
