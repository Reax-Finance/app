    ...
    const _setDetails = () => {
      ...
      for (let i in position.data) {
        let pos = {
          ...
          collateral:
            position.data[i].depositAmount /
            prices[position.data[i].tokenAddress],
          debt:
            position.data[i].borrowAmount /
            prices[position.data[i].tokenAddress],
        };
      ...
      return {
        ...
        rewardAPY: totalValue.gt(0)
          ? rewardApy.div(totalValue).toFixed(2)
          : "0",
      };
    };
      ...
      <Tr>
        ...
        <Td>
          <Box>
            <Flex gap={1} mb={1} align={"center"}>
              ...
              <Text fontSize={"sm"}>
                {dollarFormatter.format(Number(details?.collateral) || 0)}
              </Text>
            </Flex>
        ...
        <Td>
          <Flex gap={0} flexDir={"column"}>
            ...
            >
              {dollarFormatter.format(Number(position?.profitLoss))}
            </Heading>
          </Flex>
        </Td>
        ...
        <Td isNumeric>
          <Text fontSize={"sm"}>
            {new Date(position.timestampClosed * 1000).toLocaleString()}
          </Text>
        </Td>
      </Tr>
    </>
